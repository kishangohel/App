...
class IntroductionScreen extends StatefulWidget {
  ...
  /// Page controller to animate pages programatically
...
class IntroductionScreenState extends State<IntroductionScreen> {
  ...
  void initState() {
    ...
    _pageController = widget.pageController ?? PageController(initialPage: initialPage);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // Made global header behind page content
