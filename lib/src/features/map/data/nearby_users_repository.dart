...
part '_generated/nearby_users_repository.g.dart';
...
class NearbyUsersRepository {
  ...
  Stream<List<UserProfile>> usersWithinRadius(
    LatLng center,
    double radius,
  ) {
    return _geo
...
@riverpod
Stream<List<UserProfile>> nearbyUsersWithinRadius(
  NearbyUsersWithinRadiusRef ref, {
  required LatLng center,
  required double radius,
}) =>
    ref.read(nearbyUsersRepositoryProvider).usersWithinRadius(center, radius);
